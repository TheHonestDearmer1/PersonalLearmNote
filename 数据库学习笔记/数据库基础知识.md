...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517214228601.png)
...
##### [#](https://gaoziman.gitee.io/blogs/pages/6ca3af/#_3-数据库管理系统-database-management-system-简称-dbms)3. 数据库管理系统（DataBase Management System，简称 DBMS）
...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517214832448.png)

下面附一张各种人员的数据视图，知道即可：

![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517214846304.png)
...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517215228672.png)
...
#### [#](https://gaoziman.gitee.io/blogs/pages/6ca3af/#_1-2-1-两类数据模型)1.2.1 两类数据模型
...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517215434497.png)
...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517215637678.png)
...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517215900890.png)
...
##### [#](https://gaoziman.gitee.io/blogs/pages/6ca3af/#_2-模式-schema)2. 模式（Schema）
...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517220137995.png)
...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517220329725.png)
...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517220804993.png)

定义有点晦涩，看下面一个例子就懂了

![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517220820901.png)
...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517221310947.png)
...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517221352192.png)
...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517221420037.png)
...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517221442572.png)
...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517221517689.png)

④笛卡尔积 Cartesian Product

![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517221534248.png)

例图：

![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517221551547.png)
...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517221616427.png)
...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517221634135.png)

示例 3：

![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517221647884.png)

② 投影 projection

![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517221658819.png)
...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517221747947.png)

③ 连接 join

连接也称 θ 连接。从两个关系的笛卡尔积中选取属性间满足一定条件的元组

![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517221801080.png)

连接运算中有两种常用连接：

- **等值连接**：θ 为 = 的连接运算称为等值连接。他是从关系 R 与 S 的笛卡尔积中选取 A、B 属性值相等的那些元组

![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517221812243.png)

- **自然连接**：自然连接是一种特殊的等值连接。它要求两个关系中进行比较的分量必须是同名的属性组，并且在结果中把重复的属性列去掉

![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517221823262.png)

**示例：**

![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517221835766.png)
...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517221928930.png)

> 给除运算下定义：

![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517221939223.png)

`R ÷ S = T` 表示 T 包含所有在 R 但不在 S 中的属性及其值，**且 T 的元组与 S 的元组的 所有组合 都在 R中**

**示例：**可以理解为在 R 中查找 B、C 属性和 S 中的 B、C 属性相同的，A 属性的值

![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517221956774.png)
...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517222109219.png)

![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517222120601.png)

![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517222134242.png)

**② 设有如图所示的关系S、SC 和 C, 试用关系代数表达式表示下列查询语句:**

![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517222147455.png)
...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517222450869.png)
...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/img/image-20230517222814376.png)
...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/blog/image-20230308152917146.png)

## [#](https://gaoziman.gitee.io/blogs/pages/460b04/#二、解压)二、解压

**解压zip压缩包至想要安装的目录，比如解压到 D:\mysql-8.0.32-winx64**

![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/blog/image-20230308153548884.png)
...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/blog/image-20230308153653898.png)
...
## [#](https://gaoziman.gitee.io/blogs/pages/460b04/#四、运行准备)四、运行准备

**以管理员身份打开命令行，切换到安装MySQL的目录下，再切换到bin目录下**

![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/blog/image-20230308154130024.png)

**然后切换到mysql的bin目录下**

![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/blog/image-20230308163450092.png)

## [#](https://gaoziman.gitee.io/blogs/pages/460b04/#五、安装)五、安装

**执行MySQL初始化命令 mysqld --initialize --console**

![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/blog/image-20230308163623315.png)
...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/blog/image-20230308163714601.png)

`因为我这里先前已经安装了，这里只是展示一下`。

启动MySQL服务，命令为：net start mysql80。其中(停止服务：net stop mysql80 ，卸载服务：sc delete 服务名)

![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/blog/image-20230308163746873.png)
...
![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/blog/image-20230308163817166.png)

**由于自动生成的密码比较复杂，我们可以更改密码，更改密码命令为：alter user root@’localhost’ identified by ‘xsq!@123’; 其中单引号内为更改后的密码。**

![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/blog/image-20230308163834647.png)

**然后输入exit;命令退出mysql，重新登录mysql检验一下密码是否修改成功，**

![](https://gaoziman.oss-cn-hangzhou.aliyuncs.com/blog/image-20230308164103186.png)