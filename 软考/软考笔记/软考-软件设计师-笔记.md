...
![](assets/image-20230318130732097.png)
...
- 由 CPU 将数放入内存
     ...
     ​									　　　　![](assets/image-20230319101734993.png)
...
　　　​												![](assets/image-20230319101818583.png)
...
​															![](assets/image-20230319102851592.png)
...
​																	![](assets/image-20230320140213389.png)
...
### 软件质量模型
![](assets/1685074637082-03033021-2e2d-4fbb-a74f-0afb51fc7495.png)
...
1. 结构事物：结构事物是UML模型中的**名词**，通常是模型的**静态部分**，描述概念或物理元素。
   ...
   ​		![](assets/image-20230409092847753.png) 

2. 行为事物：行为事物是UML模型的**动态部分**，它们是模型中的**动词**，描述了跨越时间和空间的行为。

   ​		![](assets/image-20230409092904254.png) 

3. 分组事物：分组事物是UML模型的**组织部分**，是一些由模型分解成“盒子”。

   ​													![](assets/image-20230409093138336.png) 

4. 注释事物：注释事物是UML模型的解释部分。这些注释事物用来描述、说明和标注模型的任何元素。

   ​												![](assets/image-20230409093316591.png) 
...
1. 依赖：依赖是两个事物间的**语义关系**，其中一个事物（独立事物）发生变化会影响另一个事物（依赖事物）的语义。
   ...
   ​			![](assets/image-20230409095010416.png) 
   ​				![](assets/image-20230409095211029.png) 
...
​										![](assets/1685076961406-e231bd41-5363-4450-b54e-a54309c0ca1f.png)
...
​												![](assets/1685077163333-295177ac-f4ad-4a95-a65d-9dc2236c6395.png)
...
​												![](assets/image-20230411155910646.png)
​						![](assets/1685077213263-61f53031-dd07-45bd-85e1-97d4dd9a4ebe.png)
...
部署图展现了系统的软件和硬件之间的关系，在实施阶段使用。
												![](assets/1685077237730-1e8c994a-45de-465b-808e-282db502f286.png)
...
​																![](assets/image-20230414101050042.png)
...
​													![](assets/image-20230414103527217.png)
...
​		![](assets/image-20230415091034585.png)
...
​		![](assets/image-20230415145022868.png)
...
​									![](assets/image-20230416093633395.png)
...
​											![](assets/image-20230417135729720.png)
...
### 协议簇
​										![](assets/1685079630978-b652f779-54ff-4718-8113-e4692be411a9.png)
​												![](assets/1685079609574-90013942-1227-46ba-b363-9c059875d831.png)
...
​																![](assets/202304122204974.png)

近几年题型

​											![](https://cdn.jishuqin.cn//202304122217271.png)