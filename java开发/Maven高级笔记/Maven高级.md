...
![](assets/1630773180969.png)

安装成功后，在对应的路径下就看到安装好的jar包

![](assets/1630773262441.png)
...
![](assets/1630774696344.png)

再次对`maven_02_ssm`项目进行编译，又会报错，如下:

![](assets/1630774780211.png)
...
![](assets/1630774917743.png)

安装成功后，在对应的路径下就看到了安装好对应的jar包

![](assets/1630774946856.png)
...
![](assets/1630946592924.png)

##### 步骤2:创建子项目

该项目可以被聚合工程管理，同时会继承父工程。

![](assets/1630947082716.png)
...
![](assets/1630981519370.png)

具体如何查看这些属性:

在cmd命令行中输入`mvn help:system`

![](assets/1630981585748.png)
...
![](assets/1630988572349.png)

#### 步骤2:启动Nexus

![](assets/1630988673245.png)
...
![](assets/1630988857125.png)

#### 步骤4:首次登录重置密码

![](assets/1630988983159.png)

输入用户名和密码进行登录，登录成功后，出现如下页面

![](assets/1630989052183.png)

点击下一步，需要重新输入新密码，为了和后面的保持一致，密码修改为`admin`

![](assets/1630989094756.png)

设置是否运行匿名访问

![](assets/1630989122737.png)

点击完成

![](assets/1630989136097.png)
...
![](assets/1630990538229.png)

上面所说的这些内容，我们需要在本地Maven的配置文件`settings.xml`中进行配置。

#### 步骤1:私服上配置仓库

![](assets/1630991211000.png)
