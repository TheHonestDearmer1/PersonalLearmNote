...
* 创建SpringBoot工程
  ...
  ![](assets/1630997819698.png)

* 勾选配置使用的技术，能够实现自动添加起步依赖包

  ![](assets/1630997860020.png)

* 设置dataSource相关属性(JDBC参数)

  ![](assets/1630997901479.png)

* 定义数据层接口映射配置

  ![](assets/1630997929891.png)
...
![](assets/1630998241426.png)

#### 步骤3:勾选配置使用技术

![](assets/1630998321660.png)
...
![](assets/1631208030131.png)

#### 步骤3:运行测试程序

![](assets/1631019660480.png)
...
![](assets/1631031828378.png)

解决方案是使用MP提供的另外一个注解`@TableName`来设置表与模型类之间的对应关系。

![](assets/1631031915632.png)
...
![](assets/1631211697712.png)

当把源码下载完后，就可以看到如下内容:

![](assets/1631211902833.png)
...
![](assets/1631212469974.png)

如果设置了主键ID,则数据添加成功，如下:

![](assets/1631212421137.png)
...
对于主键ID的策略已经介绍完，但是如果要在项目中的每一个模型类上都需要使用相同的生成策略，如:![](assets/1631245676125.png)
...
![](assets/1631246688218.png)

### 4.3 逻辑删除

接下来要讲解是删除中比较重要的一个操作，逻辑删除，先来分析下问题:

![](assets/1631246806130.png)
...
![](assets/1631253387845.png)

## 5，快速开发

### 5.1 代码生成器原理分析

造句:![](assets/1631253928893.png)

我们可以往空白内容进行填词造句，比如:![](assets/1631253971409.png)

在比如:![](assets/1631253994782.png)

观察我们之前写的代码，会发现其中也会有很多重复内容，比如:

![](assets/1631254075651.png)

那我们就想，如果我想做一个Book模块的开发，是不是只需要将红色部分的内容全部更换成`Book`即可，如：

![](assets/1631254119948.png)
