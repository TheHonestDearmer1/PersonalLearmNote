...
![](assets/1630600844191.png)

查询所有，测试的结果为:

![](assets/1630600927486.png)
...
![](assets/1630652758221.png)

#### 删除

`http://localhost/books/14`

![](assets/1630652796605.png)

#### 查询单个

`http://localhost/books/1`

![](assets/1630652837682.png)

#### 查询所有

`http://localhost/books`

![](assets/1630652867493.png)
...
* 在Controller层增删改返回给前端的是boolean类型数据
  ...
  ![](assets/1630653359533.png)

* 在Controller层查询单个返回给前端的是对象

  ![](assets/1630653385377.png)

* 在Controller层查询所有返回给前端的是集合对象

  ![](assets/1630653468887.png)
...
- 业务异常（BusinessException）
  ...
  - 规范的用户行为产生的异常
    ...
    - 用户在页面输入内容的时候未按照指定格式进行数据填写，如在年龄框输入的是字符串
      ...
      ![](assets/1630659599983.png)

  - 不规范的用户行为操作产生的异常

    - 如用户故意传递错误数据

      ![](assets/1630659622958.png)
...
![](assets/1630661162758.png)

如果传入的是其他参数，会报`SystemException`

![](assets/1630661192383.png)
...
![](assets/1630661781776.png)

1. 将`资料\SSM功能页面`下面的静态资源拷贝到webapp下。

![](assets/1630663662691.png)
...
![](assets/1630666787456.png)

### 4.3 添加功能

![](assets/1630670332168.png)
