...
![](assets/1630428920116.png)

#### 步骤2:补全目录结构

因为使用骨架创建的项目结构不完整，需要手动补全

![](assets/1630429288339.png)
...
![](assets/1630430302683.png)

#### 步骤8:启动运行项目

![](assets/1630430345246.png)

#### 步骤9:浏览器访问

浏览器输入`http://localhost/save`进行访问，会报如下错误:

![](assets/1630430401561.png)
...
5. 加载UserController，每个@RequestMapping的名称对应一个具体的方法
   ...
   ![](assets/1630433398932.png)

   * 此时就建立了 `/save` 和 save方法的对应关系

6. 执行getServletMappings方法，设定SpringMVC拦截请求的路径规则

   ![](assets/1630433510528.png)
...
* PostMan是一款功能强大的网页调试与发送网页HTTP请求的Chrome插件。![](assets/1630463382386.png)
* 作用：常用于进行接口测试
...
![](assets/1630463816424.png)

看到如下界面，就说明已经安装成功。

![](assets/1630463887711.png)
...
![](assets/1630464489898.png)

#### 3.3.3 保存当前请求

![](assets/1630464783034.png)
...
![](assets/1630466431549.png)

把环境准备好后，启动Tomcat服务器，后台会报错:

![](assets/1630466555934.png)
...
![](assets/1630480964421.png)

接收参数:

控制台打印，会发现有中文乱码问题。

![](assets/1630481008109.png)
...
![](assets/1630494320917.png)

#### 步骤4:查看控制台

![](assets/1630494443738.png)
...
![](assets/1630495347289.png)

重新启动服务器，重新发送请求测试，SpringMVC就可以将日期时间的数据进行转换

![](assets/1630495507353.png)
...
![](assets/1630508310063.png)

需求二:新增图片，将新增图书的数据传递到后台，并在控制台打印

![](assets/1630508367105.png)
