...
![](assets/image-20210729111159534.png)
...
* 编写测试用例
  ...
  ![](assets/image-20210729112907106.png)
...
* 安装 MyBatisX 插件
  ...
  * 安装方式
    ...
    ![](assets/image-20210729113304743.png)

    > 注意：安装完毕后需要重启IDEA

  * 插件效果

    ![](assets/image-20210729164450524.png)
    ...
    ![](assets/image-20210729165337223.png)

### 1.2  查询所有数据

![](assets/image-20210729165724838.png)
...
* 编写接口方法：Mapper接口
  ...
  * 参数：无
    ...
    ![](assets/image-20210729171208737.png)

  * 结果：List<Brand>

    我们会将查询出来的每一条数据封装成一个 `Brand` 对象，而多条数据封装多个 `Brand` 对象，需要将这些对象封装到List集合中返回。

    ![](assets/image-20210729171146911.png)
...
![](assets/image-20210729172544230.png)
...
![](assets/image-20210729173210433.png)
...
![](assets/image-20210729180118287.png)
...
* 编写接口方法：Mapper接口
  ...
  ![](assets/image-20210729180604529.png)
...
* 编写SQL语句：SQL映射文件
  ...
  ![](assets/image-20210729180709318.png)
...
![](assets/image-20210729182223137.png)
...
* ${} ：拼接SQL。底层使用的是 `Statement`，会存在SQL注入问题。如下图将 映射配置文件中的 #{} 替换成 ${} 来看效果
  ...
  ![](assets/image-20210729184156019.png)
...
* 转义字符
  ...
  ![](assets/image-20210729185128686.png)

* <![CDATA[内容]]>

  ![](assets/image-20210729185030318.png)

### 1.4  多条件查询

![](assets/image-20210729203804276.png)
...
![](assets/image-20210729204458815.png)
...
* if 标签：条件判断
  ...
  * test 属性：逻辑表达式
  ...
  ![](assets/image-20210729212510291.png)
...
![](assets/image-20210729220348255.png)
...
* 运行程序则可以看到错误
  ...
  ![](assets/image-20210805231727206.png)
...
![](assets/image-20210805234302849.png)
