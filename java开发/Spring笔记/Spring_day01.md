...
* 从使用和占有率看
  ...
  * 所以说,Spring技术是JavaEE开发必备技能，企业开发技术选型命中率>==90%==
    ...
    ![](assets/image-20210729171139088.png)
...
* Spring发展到今天已经形成了一种开发的生态圈,Spring提供了若干个项目,每个项目用于完成特定的功能。
  ...
  * Spring有若干个项目，可以根据需要自行选择，把这些个项目组合起来，起了一个名称叫==全家桶==，如下图所示
    ...
    ![](assets/image-20210729171850181.png)
...
![](assets/image-20210729171926576.png)
...
* Spring Framework的发展也经历了很多版本的变更，每个版本都有相应的调整
  ...
  ![](assets/image-20210729172153796.png)
...
![](assets/image-20210729184337603.png)
...
![](assets/image-20210729183558051.png)
...
* 如果不存在,则会报错，如下:
  ...
  ![](assets/1629771880920.png)

  这个错误大家需要特别关注下:

  ![](assets/1629771972886.png)

  获取bean无论是通过id还是name获取，如果无法获取到，将抛出异常==NoSuchBeanDefinitionException==

#### 4.1.3 bean作用范围scope配置（多例）
...
![](assets/image-20210729183628138.png)
...
![](assets/image-20210729195248948.png)
...
![](assets/1629803111769.png)

上面已经完成了构造函数注入的基本使用，但是会存在一些问题:

![](assets/1629803529598.png)
