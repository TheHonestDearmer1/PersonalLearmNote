# 脚本语言[](https://docs.godotengine.org/zh-cn/4.x/getting_started/step_by_step/scripting_languages.html#scripting-languages)
...
![../../_images/scripting_camera_shake.gif](img/scripting_camera_shake.gif)

## 可用的脚本语言[](https://docs.godotengine.org/zh-cn/4.x/getting_started/step_by_step/scripting_languages.html#available-scripting-languages)
...
## 我应该使用哪种语言？[](https://docs.godotengine.org/zh-cn/4.x/getting_started/step_by_step/scripting_languages.html#which-language-should-i-use)

如果你是初学者，我们推荐**从 GDScript 入手**。这门语言是我们针对 Godot 和游戏开发者的需求制作的。语法简单直白，与 Godot 结合得最为紧密。

![../../_images/scripting_gdscript.png](img/scripting_gdscript.png)
...
[GDScript](https://docs.godotengine.org/zh-cn/4.x/tutorials/scripting/gdscript/gdscript_basics.html#doc-gdscript) 是一门[面向对象](https://zh.wikipedia.org/wiki/面向对象程序设计)的[指令式](https://zh.wikipedia.org/wiki/指令式編程)编程语言，专为 Godot 构建，是游戏开发者为游戏开发所制作的，目的是节省编写游戏代码的时间。其特性包括：
...
- 支持多线程，与静态类型语言的一样高效。
- 没有[垃圾回收](https://zh.wikipedia.org/wiki/垃圾回收_(計算機科學))，因为垃圾回收最终会影响游戏的开发。引擎会默认进行引用计数，在大多数情况下为你管理内存，但你也可以在需要时自行控制内存。
...
微软的 [C#](https://en.wikipedia.org/wiki/C_Sharp_(programming_language)) 深受游戏开发者的喜爱，我们对其有官方支持。C# 是一门成熟灵活的语言，拥有海量的库。得益于微软慷慨大方的捐助，才让 Godot 对 C# 的支持成为可能。

![../../_images/scripting_csharp.png](img/scripting_csharp.png)

虽然 C# 在性能和易用性之间进行了良好的平衡，但你也要注意一下其垃圾回收机制。

备注

你必须使用 .NET版本的 Godot 编辑器才能在项目中使用 C# 进行编程，可以在 Godot 网站的[下载](https://godotengine.org/download/)页面进行下载。
...
在 Godot 4 中用 C# 编写的项目目前无法导出到 Web 平台。如果要在该平台上使用 C#，请考虑使用 Godot 3。（C# 的）Android 和 iOS 平台支持从 Godot 4.2 开始提供，但仍处于实验阶段，并且[存在一些限制](https://docs.godotengine.org/zh-cn/4.x/tutorials/scripting/c_sharp/index.html#doc-c-sharp-platforms)。

参见

要了解更多关于 C# 的信息，请前往 [C# 基础](https://docs.godotengine.org/zh-cn/4.x/tutorials/scripting/c_sharp/c_sharp_basics.html#doc-c-sharp)页面。
...
![../../_images/scripting_cpp.png](img/scripting_cpp.webp)
...
## 总结[](https://docs.godotengine.org/zh-cn/4.x/getting_started/step_by_step/scripting_languages.html#summary)
